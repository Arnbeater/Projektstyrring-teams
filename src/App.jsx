...
import { doc, setDoc, getDoc, onSnapshot, collection, addDoc, deleteDoc, getDocs, query, orderBy, where } from "firebase/firestore";
import { firebaseConfig, fbAuth, fbDb } from "./config/firebase";
